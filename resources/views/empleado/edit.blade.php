                ...
                <div class="col-md-6 offset-md-3">
                  <div class="card">
                    <div class="card-header">
                      <div class="col-sm-12">
                        <h2><span class="badge badge-libreria">Editar registro <small>Asignación de extensión</small></span></h2>
                      </div><!-- /.col -->
                    </div>
                    <div class="card-body">
                        <form action="{{ url('empleados', [$empleado->id]) }}" method="POST" autocomplete="off">
                          <input name="_method" type="hidden" value="PUT">
                           @csrf
                           <div class="row">
                            <div class="form-group {{ $errors->has('cui') ? ' is-invalid' : '' }} col-md-6">
                                  <label for="cui" class="control-label">Cui</label>
                                  <input type="text" class="form-control {{ $errors->has('cui') ? ' is-invalid' : '' }}" name="cui" value="{{$empleado->cui }}">
                                  @if ($errors->has('cui'))
                              ...
                              <div class="form-group {{ $errors->has('extension') ? ' is-invalid' : '' }} col-md-6">
                                  ...
                                  <input type="text" class="form-control {{ $errors->has('extension') ? ' is-invalid' : '' }}" name="extension" value="{{ $empleado->extension }}">
                              ...
                              <div class="form-group {{ $errors->has('primer_nombre') ? ' is-invalid' : '' }} col-md-6">
                                  ...
                                  <input type="text" class="form-control {{ $errors->has('primer_nombre') ? ' is-invalid' : '' }}" name="primer_nombre" value="{{ $empleado->primer_nombre }}">
                              ...
                              <div class="form-group {{ $errors->has('segundo_nombre') ? ' is-invalid' : '' }} col-md-6">
                                  ...
                                  <input type="text" class="form-control {{ $errors->has('segundo_nombre') ? ' is-invalid' : '' }}" name="segundo_nombre" value="{{ $empleado->segundo_nombre }}">
                           ...
                           <div class="row">
                            ...
                            <div class="form-group {{ $errors->has('primer_apellido') ? ' is-invalid' : '' }} col-md-6">
                                ...
                                <input type="text" class="form-control {{ $errors->has('primer_apellido') ? ' is-invalid' : '' }}" name="primer_apellido" value="{{ $empleado->primer_apellido }}">
                                @if ($errors->has('primer_nombre'))
                                    <span class="invalid-feedback" role="alert">
                            ...
                            <div class="form-group {{ $errors->has('segundo_apellido') ? ' is-invalid' : '' }} col-md-6">
                                ...
                                <input type="text" class="form-control {{ $errors->has('segundo_apellido') ? ' is-invalid' : '' }}" name="segundo_apellido" value="{{ $empleado->segundo_apellido }}">
                           ...
                           <div class="row">
                            ...
                            <div class="form-group {{ $errors->has('departamento_id') ? ' is-invalid' : '' }} col-md-6">
                                ...
                                <select id="departamento_id" type="text" class="form-control @error('departamento_id') is-invalid @enderror" name="departamento_id">
                                    ...
                                    @foreach ($departamentos as $depto)
                                        <option value="{{$depto['id']}}" {{$empleado->departamento_id==$depto['id'] ? 'selected' : ''}}>{{$depto['nombre']}} </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group {{ $errors->has('cargo') ? ' is-invalid' : '' }} col-md-6">
                                ...
                                <input type="text" class="form-control {{ $errors->has('cargo') ? ' is-invalid' : '' }}" name="cargo" value="{{ $empleado->cargo }}">
                                @if ($errors->has('cargo'))
                                    <span class="invalid-feedback" role="alert">
